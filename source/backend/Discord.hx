...
class DiscordClient
{
	...
	private inline static final _defaultID:String = "1104009082664394912";
	...
	public static function changePresence(details:String = 'In the Menus', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
		...
		presence.largeImageText = "Engine Version: " + states.MainMenuState.asEngineVersion;
	...
	public static function loadModRPC()
	{
		...
		if (pack != null && pack.customRPC && pack.discordRPC != null && pack.discordRPC != clientID)
		{
