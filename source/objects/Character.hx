	...
	**/
	...
	public function loadCharacterFile(json:Dynamic)
	{
		...
		if (animationsArray != null && animationsArray.length > 0) {
			for (shits in animationsArray) {
				var animAnim:String = '' + shits.anim;
				var animName:String = '' + shits.name;
				var animFps:Int = shits.fps;
				var animLoop:Bool = !!shits.loop; // Bruh
				var animIndices:Array<Int> = shits.indices;
				...
				if (shits.offsets != null && shits.offsets.length > 1)
					addOffset(shits.anim, shits.offsets[0], shits.offsets[1]);
				else
					addOffset(shits.anim, 0, 0);
			}
		}
