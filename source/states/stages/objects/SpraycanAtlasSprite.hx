...
class SpraycanAtlasSprite extends FlxSpriteGroup
{
	...
	public function new(x:Float = 0, y:Float = 0)
	{
		...
		canAtlas.frames = Paths.getTextureAtlas('spraycanAtlas', 'weekend1');
		...
		canAtlas.animation.finishCallback = function(_) finishCanAnimation();
		canAtlas.visible = canAtlas.active = false;
		canAtlas.antialiasing = ClientPrefs.data.antialiasing;
		add(canAtlas);

		explosion = new FlxSprite(x + 350, y + 170);
